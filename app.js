...
bot.on('message', message => {
  ...
  if (sender.id === '388635602112872448') {
      return;
  }  
  ...
  //Bad Words
  if (msg.includes('PUTA') || msg.includes('MERDA') || msg.includes('FDS') || msg.includes('FDP') || msg.includes('CARALHO') || msg.includes('PQP')  || msg.includes('CLRH') || msg.includes('PUSSY') || msg.includes('CONA') || msg.includes('ASS')) {
    message.delete();
